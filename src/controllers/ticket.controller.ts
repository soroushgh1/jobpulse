...
export class TicketController {
  ...
  @UseGuards(AuthGuard)
  async createTicket(@Body() input: TicketMakeDto, @Req() req) {
  ...
  @Post('attach/:slug')
  @UseGuards(AuthGuard, AdminGuard)
  async adminAttach(@Param('slug') ticketSlug: string, @Req() req): Promise<any> {
  ...
  @Post('message/:slug')
  @UseGuards(AuthGuard)
  async sendMessage(@Body() input: MessageDTO, @Param('slug') ticketSlug: string, @Req() req): Promise<any> {
  ...
  @HttpCode(HttpStatus.OK)
  @UseGuards(AuthGuard)
  async myTickets(@Req() req): Promise<any> {
  ...
  @HttpCode(HttpStatus.OK)
  @UseGuards(AuthGuard)
  async deleteTicket(@Param('slug') ticketSlug: string, @Req() req): Promise<any> {
  ...
  @HttpCode(HttpStatus.OK)
  @UseGuards(AuthGuard)
  async updateTicket(@Param('slug') ticketSlug: string, @Body() input: TicketUpdateDto, @Req() req): Promise<any> {
  ...
  @HttpCode(HttpStatus.OK)
  @UseGuards(AuthGuard)
  async userViewTicket(@Param('slug') slug: string, @Req() req) {
